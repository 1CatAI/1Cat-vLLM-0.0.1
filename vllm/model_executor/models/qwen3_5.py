...
class Qwen3_5Model(Qwen3NextModel):
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        # as separate weights, which need to be merged into
        # in_proj_qkvz and in_proj_ba MergedColumnParallelLinear layers.
        stacked_params_mapping = [
            ...
            # GDN: in_proj_qkv → shards (0,1,2), in_proj_z → shard 3
            ("in_proj_qkvz", "in_proj_qkv", (0, 1, 2)),
            ("in_proj_qkvz", "in_proj_z", 3),
            # GDN: in_proj_b → shard 0, in_proj_a → shard 1
